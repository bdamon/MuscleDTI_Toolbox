...
% This version of compute_muscle_strain.m produces the muscle strain measurements
...
%% Compute Jacobian and strain fields

jacobian_displ_field=jacobian(displ_field_x,displ_field_y,...
    displ_field_z,dti_resol);

tic
%Compute Cauchy-Strain and Green-Strain tensor
[~,C_cauchy_strain,E_green_strain] = strain_tensors(...
    displ_field_x,displ_field_y,...
    displ_field_z,dti_resol);

%Compute muscle strain invariants

[along_fiber_strain,along_fiber_shear,cross_fiber_shear] = strain_invariants(...
    E1map_smooth,C_cauchy_strain,muscle_mask);
toc