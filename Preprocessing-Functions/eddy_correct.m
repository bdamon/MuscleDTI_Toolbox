...
%       -status      : 'active' or 'passive'; lower case
%       -stack       : Imaging stack; 's1' or 's2'; lower case
%       -scan_label  : Addition label for the scan, e.g. 'NSA4_10'
...
subj_out_dir = sprintf('%s/%s/%s/%s', ...
    ...
    DTI_scan_info.subject, ...
    DTI_scan_info.status, ...
    DTI_scan_info.stack);
