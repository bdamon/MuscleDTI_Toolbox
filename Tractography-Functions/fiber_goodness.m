...
num_tracked=[(last_row-first_row+1)*(last_col-first_col+1) sum(sum(roi_flag)) num_tracked];       %add number of potential fiber tracts and umber generated by fiber_track to num_tracked
